...
function WebinarProgramRightSide() {
  ...
  return (
    <div className={`px-4 py-2 ${RightPannelStyles["wrapper"]}`}>
        ...
        <div className="col-6 position-relative" style={{ overflow: "hidden", borderTopLeftRadius: "0.5rem", borderBottomRightRadius: "3rem" }}>
        <Image
        ...
        <div className="col-6 position-relative" style={{ overflow: "hidden", borderTopRightRadius: "0.5rem", borderBottomLeftRadius: "3rem" }}>
        <Image
      ...
      <div className="row h-50">
        <div className="col-6 position-relative" style={{ overflow: "hidden", borderBottomLeftRadius: "0.5rem", borderTopRightRadius: "3rem"}}>
        <Image
        ...
        <div className="col-6 position-relative" style={{ overflow: "hidden", borderBottomRightRadius: "0.5rem", borderTopLeftRadius: "3rem"  }}>
        <Image
