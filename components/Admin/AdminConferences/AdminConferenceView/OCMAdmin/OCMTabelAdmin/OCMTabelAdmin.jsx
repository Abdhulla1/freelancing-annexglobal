...
export default function SpeakerTabelAdmin({
  ...
  const handleStatusChange = async (newStatus, id) => {
    try {
      const response = await updateOCMStatus(selectedConferenceID, {
        ocmId: id,
        status: newStatus,
      });
                ...
                <tr key={i}>
                  ...
                  <td className="p-3  table-data ">
                    ...
                    <InputSwitch
                      ...
                      onChange={(e) =>
                        handleStatusChange(e.value, element.ocmId)
                      }
                      style={{ scale: "0.7" }}
                    />
                  </td>
                  <td className="p-3 table-data ">
                    <div className="d-flex gap-1  justify-content-center flex-nowrap">
                      ...
                      <button
                        className="btn btn-outline-secondary rounded"
                        onClick={() =>
                          confirmDelete(element.ocmId, element.imageUrl)
                        }
                      >
