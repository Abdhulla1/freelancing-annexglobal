...
export default function WebinarProgramTableAdmin({
  visibleDetails,
  setVisibleDetails,
}) {
  ...
  return (
    <div className="table-responsive">
      ...
      <table className="tabel w-100 mt-4  table-striped-columns">
        ...
        <tbody>
          {webinarProgramData.map((element, i) => (
            <tr key={i}>
  ...
  return (
    <div className="container-fluid px-3">
      ...
      >
         ...
         <div>
          <label className="form-label mt-5">Upload Program</label>
          <DropZoneFile />
        </div>
                <FileUpload title="Cover Image" />
...
function Delete({ data = null }) {
  return (
    <div className="d-flex flex-column align-items-center text-center">
      ...
      <h5 className="mt-3">Delete Webinar Program</h5>
